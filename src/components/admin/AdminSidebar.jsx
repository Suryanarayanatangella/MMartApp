import { LayoutDashboard, Package, ShoppingBag,LogOut, Store,ChevronLeft,ChevronRight } from "lucide-react";
import { useState } from "react";
import { useDispatch } from "react-redux";
import { NavLink, useNavigate } from "react-router-dom";
import {logout} from '../../store/authSlice'
import {clearCart as clearCartAction} from '../../store/cartSlice'
const navItems= [
    {
        to:'/admin',
...
export default function AdminSidebar(){
   ...
   return(
    <aside className={`flex flex-col bg-gray-900 text-white h-screen flex-shrink-0 transition-all duration-300 ${collapsed ? "w-16":"w-56"}`}>
        {/* Logo */}
