...
import type { CartItem, CartAISuggestionsData } from '../index';
...
export default function CartPage() {
  ...
  const [aiSuggestions, setAiSuggestions] = useState<CartAISuggestionsData | null>(null);
  ...
  const fetchAISuggestions = async (): Promise<void> => {
    ...
    setAiLoading(true);
    try {
      const res = await api.post<CartAISuggestionsData>('/api/cart-ai/suggestions', {
        cartItems: items.map((i) => ({ productId: i.productId || i.product?.id })),
      });
      setAiSuggestions(res as unknown as CartAISuggestionsData);
    } catch {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h3
                        onClick={() => navigate(`/product/${item.product.id}`)}
                        className="font-semibold text-gray-900 text-sm line-clamp-2 mb-1 cursor-pointer hover:text-blue-600"
                      >
                        {item.product.name}
                      </h3>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <button
                  onClick={() => navigate('/store')}
                  className="w-full mt-3 border border-gray-300 text-gray-700 py-3 rounded-lg font-medium hover:bg-gray-50"
                >
                  Continue Shopping
                </button>
              </div>
